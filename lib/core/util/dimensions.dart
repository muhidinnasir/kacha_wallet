...
class Dimensions {
  static double fontSizeExtraSmall = ResponsiveHelper.isTab(
          NavigatorService.navigatorKey.currentState!.context)
      ? 14
      : 10.0;
  static double fontSizeSmall = ResponsiveHelper.isTab(
          NavigatorService.navigatorKey.currentState!.context)
      ? 16
      : 12.0;
  static double fontSizeDefault = ResponsiveHelper.isTab(
          NavigatorService.navigatorKey.currentState!.context)
      ? 18
      : 14.0;
  static double fontSizeLarge = ResponsiveHelper.isTab(
          NavigatorService.navigatorKey.currentState!.context)
      ? 22
      : 16.0;
  static double fontSizeExtraLarge = ResponsiveHelper.isTab(
          NavigatorService.navigatorKey.currentState!.context)
      ? 26
      : 18.0;
  static double fontSizeOverLarge = ResponsiveHelper.isTab(
          NavigatorService.navigatorKey.currentState!.context)
      ? 28
      : 24.0;
